...
const Layout = ({ children }) => {
  return (
    <div className="flex flex-col min-h-screen antialiased text-gray-900 bg-gray-50 dark:bg-gray-800 dark:text-gray-100">
      <div className="sticky top-0 z-10 bg-white border-b border-gray-300 bg-opacity-60 dark:bg-gray-900 dark:border-gray-700 dark:bg-opacity-80 backdrop-filter backdrop-blur-xl">
